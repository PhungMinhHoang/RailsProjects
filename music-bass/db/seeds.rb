...
a8 = Album.create(cover: "https://upload.wikimedia.org/wikipedia/vi/9/9e/Sontungmtpalbumcover.jpg", title: "MTP", artist: "Son Tung MTP")
Track.create(name: "Hay Trao Cho Anh", minutes: 9, album_id: a8.id)